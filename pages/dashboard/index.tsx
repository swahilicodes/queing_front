...
export default function Dashboard() {
 const {data} = useFetchData("https://qms-back.mloganzila.or.tz/tickets/getTickets")
 const {data:week} = useFetchData("https://qms-back.mloganzila.or.tz/tickets/getWeekTickets")
 const {data:month} = useFetchData("https://qms-back.mloganzila.or.tz/tickets/getMonthTickets")
 const {data:services} = useFetchData("https://qms-back.mloganzila.or.tz/services/get_all_services")
 const {data:admins} = useFetchData("https://qms-back.mloganzila.or.tz/admins/get_all_admins")
 const {data:attends} = useFetchData("https://qms-back.mloganzila.or.tz/attendants/get_all_attendants")
 const {data:counters} = useFetchData("https://qms-back.mloganzila.or.tz/counters/get_all_counters")
 const {data:ads} = useFetchData("https://qms-back.mloganzila.or.tz/adverts/get_all_adverts")
