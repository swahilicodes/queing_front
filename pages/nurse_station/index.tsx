...
export default function CashierQueue() {
  ...
  //const {data:queue,loading,error} = useFetchData("http://192.168.30.246:5005/tickets/getTickets")
  ...
  //const eventSource = new EventSource('http://192.168.30.246:5005/socket/display_tokens_stream');
  ...
  const getActive = () => {
    axios
      .get(`http://192.168.30.246:5005/active/get_active`, { params: { page: "/nurse_station" } })
      .then((data) => {
  ...
  const getTickets = () => {
    setLoading(true);
    axios
      .get("http://192.168.30.246:5005/tickets/get_clinic_tokens", {
