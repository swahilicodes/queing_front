...
const handleMrTime = (haveMedical:boolean) => {
    if(fields.isBima && (fields.isNHIF===false && fields.isOther===false)){
        ...
        setFields({...fields,isMrTime: true,hasMedical:haveMedical?true:false,dontHaveMedical:haveMedical?false:true})
    }
}
    ...
    <div className={styles.ticket}>
      ...
      <div className={styles.ticket_top}>
        ...
        <div className={styles.center}>
            <div className={styles.item} onClick={()=> setFields({...fields,isBima: true,isCash: false})}>
                <p>{language==="Swahili"?"Bima":"Insurance"}</p>
            </div>
            <div className={styles.item} onClick={()=> setFields({...fields,isCash: true,isBima: false})}>
