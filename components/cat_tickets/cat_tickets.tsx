...
useEffect(()=> {
 ...
 const getTickets = () => {
    axios.get('http://192.168.30.246:5000/tickets/getWaitingTickets',{params: {page,pagesize,category}}).then((data:any)=> {
 ...
 const getCounter = () => {
    axios.get('http://192.168.30.246:5000/tickets/getTicketCounter',{params: {category:category}}).then((data:any)=> {
