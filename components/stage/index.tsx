...
function StageGraph() {
  ...
  const getClinics = () => {
    axios.get("http://192.168.30.246:5005/clinic/get_clinics")
      .then((data: any) => {
  ...
  const getPeaks = () => {
    axios.get("http://192.168.30.246:5005/analytics/peak_times",{params: {time: fields.time}})
      .then((data: any) => {
  ...
  const getStagers = () => {
    axios.get("http://192.168.30.246:5005/analytics/stage_analytics",{params: {stage: fields.stage,time_factor:fields.time, clinic: fields.clinic}})
      .then((data: any) => {
        setStagers(data.data)
        setTokens(data.data)
      })
